...
$rows = $ci->front_model->top_weekly_post(4,0,'top_weekly')->result();
if($rows){
?>

<header class="panel-default"> 
	<div class="panel-heading"><b>Top Weekly</b>				
...
<div class="row-flex row-flex-wrap"> 
	...
	?>
	<div class="col-sm-6 col-xs-6 col-md-3 col-lg-3 group-item col">
